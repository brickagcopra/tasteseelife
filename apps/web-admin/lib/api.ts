...
/**
 * Server-side HTTP client for talking to api-gateway (TS-123).
 *
 * Mirrors `apps/web-provider/lib/api.ts` / `apps/web-family/lib/api.ts`.
...
export interface CallOptions {
   ...
   * pre-auth login / refresh / MFA-verify endpoints.
   */

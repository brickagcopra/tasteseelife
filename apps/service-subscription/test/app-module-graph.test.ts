...
/**
 * Boot-graph guard for service-subscription (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_subscription?schema=public',
...
describe('service-subscription AppModule dependency graph', () => {

...
/**
 * Boot-graph guard for service-content (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_content?schema=public',
...
describe('service-content AppModule dependency graph', () => {

...
interface LivenessResponse {
  readonly status: 'ok';
  readonly service: 'service-accounting';
 ...
 *              real traffic — currently that means the Postgres pool is
 *              healthy. Used by Service load-balancers to remove unready
 *              pods from rotation. A 503 here pulls the pod out of the
 *              LB pool but does NOT restart it.
 *

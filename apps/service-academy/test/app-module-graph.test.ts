...
/**
 * Boot-graph guard for service-academy (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ACADEMY_CERTIFICATION_RENEWALS_INTERNAL_API_KEY:
  ...
  ACADEMY_PUBLIC_BASE_URL: 'http://127.0.0.1:1/stub',
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_academy?schema=public',
...
describe('service-academy AppModule dependency graph', () => {

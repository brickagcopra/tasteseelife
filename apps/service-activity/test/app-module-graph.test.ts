...
/**
 * Boot-graph guard for service-activity (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ACTIVITY_INGEST_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ACTIVITY_INGEST_HEADER_NAME: 'x-internal-api-key',
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_activity?schema=public',
...
describe('service-activity AppModule dependency graph', () => {

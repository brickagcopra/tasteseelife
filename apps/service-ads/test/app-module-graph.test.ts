...
/**
 * Boot-graph guard for service-ads (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ...
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_ads?schema=public',
...
describe('service-ads AppModule dependency graph', () => {

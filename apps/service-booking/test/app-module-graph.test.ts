...
/**
 * Boot-graph guard for service-booking (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ...
  BOOKING_TIER_DISPATCH_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ...
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_booking?schema=public',
  ...
  OUTBOX_PRODUCER_SERVICE: 'booking',
...
describe('service-booking AppModule dependency graph', () => {

...
/**
 * Boot-graph guard for service-analytics (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_analytics?schema=public',
  INTERNAL_AGGREGATION_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
...
describe('service-analytics AppModule dependency graph', () => {

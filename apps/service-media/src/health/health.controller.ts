...
interface LivenessResponse {
  readonly status: 'ok';
  readonly service: 'service-media';
 ...
 *              is healthy. Used by Service load-balancers.
 *
 * Future follow-ups will extend the readiness check with an S3 ping for
 * live-mode deployments (TS-110-followup-2) and a ClamAV ping for the
 * media-processor sidecar (TS-110-followup-3) — additive, no contract
 * break.
 */
@Controller()

...
/**
 * Boot-graph guard for service-messaging (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_messaging?schema=public',
  ...
  PORT: '3999',
  REDIS_KEY_NAMESPACE_PREFIX: 'test:service-messaging:',
  REDIS_URL: 'redis://127.0.0.1:6379',
  SERVICE_VERSION: 'boot-graph-test',
  WS_CORS_ORIGINS: 'http://127.0.0.1:3000',
  WS_PATH: '/socket.io',
};

describe('service-messaging AppModule dependency graph', () => {

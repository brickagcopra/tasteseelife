...
/**
 * Boot-graph guard for service-identity (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_identity?schema=public',
  IDENTITY_PRIVACY_EXPORT_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ...
  KYC_PAYLOAD_ENC_KEY: 'BwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwc=',
  KYC_PAYLOAD_ENC_KEY_VERSION: '1',
  KYC_WEBHOOK_INTERNAL_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  LOG_LEVEL: 'warn',
  MFA_CHALLENGE_SECRET: 'stub-value-long-enough-for-min-length-checks-0123456789',
  MFA_TOTP_ENC_KEY: 'BwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwc=',
  MFA_TOTP_ENC_KEY_VERSION: '1',
  MFA_TOTP_ISSUER: 'stub-value-long-enough-for-min-length-checks-0123456789',
  NODE_ENV: 'test',
  ...
  REFRESH_COOKIE_SECURE: 'stub-value-long-enough-for-min-length-checks-0123456789',
  SERVICE_VERSION: 'boot-graph-test',
  STRIPE_IDENTITY_RETURN_URL: 'http://127.0.0.1:1/stub',
  STRIPE_SECRET_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
};

describe('service-identity AppModule dependency graph', () => {

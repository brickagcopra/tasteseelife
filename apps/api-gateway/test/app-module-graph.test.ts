...
/**
 * Boot-graph guard for api-gateway (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ACADEMY_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  ACCOUNTING_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  ADS_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  ANALYTICS_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  AUDIT_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  BOOKING_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  CONCIERGE_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  CONTENT_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  HOUSEHOLD_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  HOUSEHOLD_VISIT_PREP_INTERNAL_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  HOUSEHOLD_VISIT_PREP_INTERNAL_HEADER_NAME: 'x-internal-api-key',
  ...
  LOG_LEVEL: 'warn',
  MEDIA_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  NODE_ENV: 'test',
  NOTIFICATION_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  OTEL_EXPORTER_OTLP_ENDPOINT: 'http://127.0.0.1:1/stub',
  OTEL_METRICS_ENABLED: 'false',
  OTEL_TRACES_ENABLED: 'false',
  PAYOUTS_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  PORT: '3999',
  PROVIDER_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  REDIS_URL: 'redis://127.0.0.1:6379',
  SEARCH_INDEX_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  SEARCH_INDEX_HEADER_NAME: 'x-internal-api-key',
  SEARCH_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  SERVICE_VERSION: 'boot-graph-test',
  SUBSCRIPTION_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  TRUST_SAFETY_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
};

describe('api-gateway AppModule dependency graph', () => {

...
/**
 * Boot-graph guard for service-concierge (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  CONCIERGE_TRANSPORTATION_INTERNAL_API_KEY:
    'stub-value-long-enough-for-min-length-checks-0123456789',
  CONCIERGE_TRANSPORTATION_INTERNAL_HEADER_NAME: 'x-internal-api-key',
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_concierge?schema=public',
...
describe('service-concierge AppModule dependency graph', () => {

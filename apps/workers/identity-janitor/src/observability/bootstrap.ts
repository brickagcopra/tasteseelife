 ...
 * instrumented module (`@nestjs/core`, `pg`, ...) is required, so
 ...
 * janitor's domain metrics live in `JanitorMetrics` (service-local); the
...
createObservabilityBootstrap('worker-identity-janitor');

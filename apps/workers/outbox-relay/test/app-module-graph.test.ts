...
/**
 * Boot-graph guard for worker-outbox-relay (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/outbox_relay?schema=public',
  LOG_LEVEL: 'warn',
  NODE_ENV: 'test',
  OTEL_EXPORTER_OTLP_ENDPOINT: 'http://127.0.0.1:1/stub',
  OTEL_METRICS_ENABLED: 'false',
  OTEL_TRACES_ENABLED: 'false',
  OUTBOX_SOURCES: 'identity.outbox_events',
  PORT: '3999',
  REDIS_URL: 'redis://127.0.0.1:6379',
  SERVICE_VERSION: 'boot-graph-test',
};

describe('worker-outbox-relay AppModule dependency graph', () => {

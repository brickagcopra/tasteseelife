...
/**
 * Boot-graph guard for worker-analytics-aggregator (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ANALYTICS_AGGREGATION_INTERNAL_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ANALYTICS_AGGREGATION_INTERNAL_HEADER_NAME: 'x-internal-api-key',
  ANALYTICS_AGGREGATOR_ENABLED: 'false',
...
describe('worker-analytics-aggregator AppModule dependency graph', () => {

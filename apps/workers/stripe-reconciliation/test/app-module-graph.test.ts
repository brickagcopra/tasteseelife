...
/**
 * Boot-graph guard for worker-stripe-reconciliation (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ...
  STRIPE_RECONCILIATION_INTERNAL_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  STRIPE_RECONCILIATION_INTERNAL_HEADER_NAME: 'x-internal-api-key',
};

describe('worker-stripe-reconciliation AppModule dependency graph', () => {

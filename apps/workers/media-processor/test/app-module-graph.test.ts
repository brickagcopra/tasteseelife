...
/**
 * Boot-graph guard for worker-media-processor (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ...
  PORT: '3999',
  SCAN_EVENT_INGEST_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  SCAN_EVENT_INGEST_API_KEY_HEADER: 'stub-value-long-enough-for-min-length-checks-0123456789',
  SCAN_EVENT_INGEST_URL: 'http://127.0.0.1:1/stub',
  SERVICE_VERSION: 'boot-graph-test',
};

describe('worker-media-processor AppModule dependency graph', () => {

...
/**
 * Boot-graph guard for worker-certification-renewal (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ACADEMY_CERTIFICATION_RENEWALS_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ACADEMY_CERTIFICATION_RENEWALS_HEADER_NAME: 'x-internal-api-key',
  ACADEMY_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  CERTIFICATION_RENEWAL_APP_NAME: 'stub-value-long-enough-for-min-length-checks-0123456789',
  CERTIFICATION_RENEWAL_ENABLED: 'false',
  CERTIFICATION_RENEWAL_RENEW_URL: 'http://127.0.0.1:1/stub',
...
describe('worker-certification-renewal AppModule dependency graph', () => {

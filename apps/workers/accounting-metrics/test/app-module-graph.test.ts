...
/**
 * Boot-graph guard for worker-accounting-metrics (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ACCOUNTING_METRICS_ENABLED: 'false',
  ACCOUNTING_SAAS_METRICS_INTERNAL_API_KEY:
    'stub-value-long-enough-for-min-length-checks-0123456789',
  ACCOUNTING_SAAS_METRICS_INTERNAL_HEADER_NAME: 'x-internal-api-key',
...
describe('worker-accounting-metrics AppModule dependency graph', () => {

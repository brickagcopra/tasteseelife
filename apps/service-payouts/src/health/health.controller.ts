...
interface LivenessResponse {
  readonly status: 'ok';
  readonly service: 'service-payouts';
 ...
 *
 * TS-091 will extend the readiness check with a Stripe API ping for
 * live-mode deployments — additive, no contract break.
 */
@Controller()

...
/**
 * Boot-graph guard for service-payouts (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_payouts?schema=public',
  ...
  PAYOUT_TRANSFERS_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  PAYOUT_TRANSFERS_HEADER_NAME: 'x-internal-api-key',
  PORT: '3999',
  SERVICE_VERSION: 'boot-graph-test',
  STRIPE_EVENTS_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  STRIPE_EVENTS_HEADER_NAME: 'x-internal-api-key',
  STRIPE_SECRET_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  STRIPE_STUB_ONBOARDING_BASE_URL: 'http://127.0.0.1:1/stub',
};

describe('service-payouts AppModule dependency graph', () => {

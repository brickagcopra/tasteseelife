...
/**
 * Boot-graph guard for service-search (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  ADS_INTERNAL_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ADS_INTERNAL_HEADER_NAME: 'x-internal-api-key',
  ADS_SERVICE_BASE_URL: 'http://127.0.0.1:1/stub',
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_search?schema=public',
  ELASTICSEARCH_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ELASTICSEARCH_NODE_URL: 'http://127.0.0.1:1/stub',
  ELASTICSEARCH_PASSWORD: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ELASTICSEARCH_TLS_REJECT_UNAUTHORIZED: 'true',
  ELASTICSEARCH_USERNAME: 'stub-value-long-enough-for-min-length-checks-0123456789',
  ...
  OUTBOX_PRODUCER_SERVICE: 'search',
  PORT: '3999',
  SEARCH_INDEX_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  SEARCH_INDEX_HEADER_NAME: 'x-internal-api-key',
  SEARCH_PROVIDER_INDEX_NAME: 'stub-value-long-enough-for-min-length-checks-0123456789',
  SERVICE_VERSION: 'boot-graph-test',
};

describe('service-search AppModule dependency graph', () => {

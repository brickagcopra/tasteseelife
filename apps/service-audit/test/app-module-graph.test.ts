...
/**
 * Boot-graph guard for service-audit (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  AUDIT_INGEST_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  AUDIT_INGEST_HEADER_NAME: 'x-internal-api-key',
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_audit?schema=public',
...
describe('service-audit AppModule dependency graph', () => {

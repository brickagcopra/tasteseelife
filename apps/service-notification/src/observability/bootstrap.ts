/**
 * OpenTelemetry tracing + Prometheus metrics bootstrap for service-notification
 * (TS-306-followup-1d).
 *
 ...
 *
 * The load-bearing auto-instrumented signal here is `http`: this service talks
 * to third-party delivery providers, whose latency is neither ours to control
 * nor visible anywhere else, and template render-on-demand sits in front of
...
createObservabilityBootstrap('service-notification');

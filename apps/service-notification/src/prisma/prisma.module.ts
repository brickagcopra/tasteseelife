 ...
 * extension (TS-141 / TS-020-followup-2b-platform-rollout) is applied
 * to the DI-resolved instance. The factory:
 *
 ...
 * `this.prisma.notificationTemplate`, `this.prisma.notificationDispatch`,

...
/**
 * Boot-graph guard for service-provider (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  BACKGROUND_CHECK_PAYLOAD_ENC_KEY: 'BwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwc=',
  ...
  CALENDAR_TOKEN_ENC_KEY: 'BwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwc=',
  CALENDAR_TOKEN_ENC_KEY_VERSION: '1',
  CHECKR_API_BASE_URL: 'http://127.0.0.1:1/stub',
  CHECKR_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  CHECKR_DEFAULT_PACKAGE: 'stub-value-long-enough-for-min-length-checks-0123456789',
  CHECKR_DEFAULT_WORK_LOCATION_STATES: 'stub-value-long-enough-for-min-length-checks-0123456789',
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_provider?schema=public',
  GOOGLE_CALENDAR_OAUTH_CLIENT_ID: 'stub-value-long-enough-for-min-length-checks-0123456789',
  GOOGLE_CALENDAR_OAUTH_CLIENT_SECRET: 'stub-value-long-enough-for-min-length-checks-0123456789',
  GOOGLE_CALENDAR_OAUTH_REDIRECT_URI: 'http://127.0.0.1:1/stub',
  GOOGLE_CALENDAR_OAUTH_STATE_SECRET: 'stub-value-long-enough-for-min-length-checks-0123456789',
  GOOGLE_CALENDAR_POST_CONNECT_REDIRECT_URL: 'http://127.0.0.1:1/stub',
  ...
  PROVIDER_BILLING_CONTACTS_INTERNAL_API_KEY:
    'stub-value-long-enough-for-min-length-checks-0123456789',
  PROVIDER_DISCOVERY_INTERNAL_API_KEY: 'stub-value-long-enough-for-min-length-checks-0123456789',
  PROVIDER_DISCOVERY_INTERNAL_HEADER_NAME: 'x-internal-api-key',
  REDIS_URL: 'redis://127.0.0.1:6379',
  SERVICE_VERSION: 'boot-graph-test',
};

describe('service-provider AppModule dependency graph', () => {

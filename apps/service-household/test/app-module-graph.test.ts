...
/**
 * Boot-graph guard for service-household (TS-506).
 *
...
const STUB_ENV: Record<string, string> = {
  DATABASE_URL: 'postgresql://stub:stub@127.0.0.1:5432/service_household?schema=public',
  HOUSEHOLD_ACCESS_ENC_KEY: 'BwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwc=',
  HOUSEHOLD_ACCESS_ENC_KEY_VERSION: '1',
  HOUSEHOLD_INTAKE_ENC_KEY: 'BwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwcHBwc=',
...
describe('service-household AppModule dependency graph', () => {
